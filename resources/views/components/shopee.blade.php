...
<div class="row">
    <div class="col-lg-6 col-xl-3">
        <div class="widget-bg-color-icon card-box fadeInDown animated">
            ...
            <div class="text-right">
                <h3 class="text-dark m-t-10"><b class="counter">{{$user_login->shopee_package}}</b>
                </h3>
    ...
    <div class="col-lg-6 col-xl-3">
        <div class="widget-bg-color-icon card-box fadeInDown animated">
            ...
            <div class="text-right">
                <h3 class="text-dark m-t-10"><b class="counter">{{\App\Common\Utils::countDayLeft($user_login->shopee_end_date)}}</b></h3>
                <p class="text-muted mb-0">Thời hạn sử dụng {{gmdate("Y/m/d",$user_login->shopee_end_date + 7 * 3600)}}</p>
            </div>
            <div class="clearfix"></div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-xl-3">
        <div class="widget-bg-color-icon card-box fadeInDown animated">
            ...
            <div class="text-right">
                <h3 class="text-dark m-t-10"><b class="counter count_run"><span id="count_run">{{$countRun}}</span>/{{$user_login->shopee_key_live}} luồng</b>
                </h3>
...
@endif
@if(isset($notify) && !empty($notify->content))
<div class="row animated fadeInDown">
    <div class="col-lg-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 color-red">Thông báo</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-6 col-form-label"><a class="" target="_blank" href="https://live.shopee.vn/pc/setup" style="background: #121318; border-radius: 5px;padding: 10px;">Tạo video trực tiếp trên Shopee</a></label>
...
<!--                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    ...
                                    <button type="button"
                                            data-type="shopee"
                                            class="btn-live-type btn-icon cur-point m-r-15"
                                            value="rtmp://push-tx.lvb.shopee.vn/live/">
                                        <i class="" data-toggle="tooltip" data-placement="top" title="Shoppe">Shopee</i></button>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-6 col-form-label">Url Live</label>
                                <div class="col-12">
                                    <!--<input type="text" id="key_live" class="form-control" name="key_live">-->
                                    <textarea id="url_live" name="url_live" class="form-control resize-ta" rows="3" spellcheck="false"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--                    <div class="div_live_repeat m-l-15 animated wow">
            ...
            <!--<div><a class="facebook-live" target="_blank" href="https://live.shopee.vn/pc/setup" style="top: 185px;left: 823px;">Tạo video trực tiếp trên Shopee</a></div>-->
        </div>
    </div>
</div>
<div class="row animated fadeInDown">
                ...
                <table id="table-live" class="table hover-button-table">
                    ...
                    <tbody>
                        ...
                        <tr class="{{$red}}">
                            ...
                            <td class="text-left">
                                @if(\App\Common\Utils::containString($data->url_live,'shopee'))
                                Shopee
                                @elseif(\App\Common\Utils::containString($data->url_live,'lazada'))
                                Lazada
                                @endif
                            </td>
