...
!function($){function numberRoller(e){var n=$(".roller-title-number-"+e).attr("data-min"),t=$(".roller-title-number-"+e).attr("data-max"),a=$(".roller-title-number-"+e).attr("data-delay");numberRoll(e,n,t,$(".roller-title-number-"+e).attr("data-increment"),1e3*a/(t-n))}function numberRoll(slno,min,max,increment,timeout){min<=max?($(".roller-title-number-"+slno).html(min),min=parseInt(min)+parseInt(increment),setTimeout(function(){numberRoll(eval(slno),eval(min),eval(max),eval(increment),eval(timeout))},timeout)):$(".roller-title-number-"+slno).html(max)}$(window).on("load",function(){$(document).scrollzipInit(),$(document).rollerInit()}),$(window).on("load scroll resize",function(){$(".numscroller").scrollzip({showFunction:function(){numberRoller($(this).attr("data-slno"))},wholeVisible:!1})}),$.fn.scrollzipInit=function(){$("body").prepend("<div style='position:fixed;top:0px;left:0px;width:0;height:0;' id='scrollzipPoint'></div>")},$.fn.rollerInit=function(){var e=0;$(".numscroller").each(function(){e++,$(this).attr("data-slno",e),$(this).addClass("roller-title-number-"+e)})},$.fn.scrollzip=function(e){var t=$.extend({showFunction:null,hideFunction:null,showShift:0,wholeVisible:!1,hideShift:0},e);return this.each(function(e,n){return $(this).addClass("scrollzip"),$.isFunction(t.showFunction)&&0<$("#scrollzipPoint").length&&!$(this).hasClass("isShown")&&$(window).outerHeight()+$("#scrollzipPoint").offset().top-t.showShift>$(this).offset().top+(t.wholeVisible?$(this).outerHeight():0)&&$("#scrollzipPoint").offset().top+(t.wholeVisible?$(this).outerHeight():0)<$(this).outerHeight()+$(this).offset().top-t.showShift&&($(this).addClass("isShown"),t.showFunction.call(this)),$.isFunction(t.hideFunction)&&$(this).hasClass("isShown")&&($(window).outerHeight()+$("#scrollzipPoint").offset().top-t.hideShift<$(this).offset().top+(t.wholeVisible?$(this).outerHeight():0)||$("#scrollzipPoint").offset().top+(t.wholeVisible?$(this).outerHeight():0)>$(this).outerHeight()+$(this).offset().top-t.hideShift)&&($(this).removeClass("isShown"),t.hideFunction.call(this)),this})}}(jQuery);var darkMode="false";"undefined"!=typeof Storage&&(darkMode=localStorage.getItem("luxiDarkMode")||"false");var $header=$("#header"),$menu=$("#mobile_menu"),$slideMenu=$("#slide-menu"),isOpen=!1;$(document).ready(function(){"true"===darkMode&&($("#app").removeClass("theme--light"),$("#app").addClass("theme--dark"),$("#theme_switcher").prop("checked",!0)),$("#theme_switcher").change(function(){$(this).is(":checked")?(localStorage.setItem("luxiDarkMode","true"),$("#app").removeClass("theme--light"),$("#app").addClass("theme--dark")):(localStorage.setItem("luxiDarkMode","false"),$("#app").removeClass("theme--dark"),$("#app").addClass("theme--light"))}),$(".dropdown-trigger").dropdown({closeOnClick:!1,alignment:"left"}),$("#mobile_menu").click(function(){(isOpen=!isOpen)?$(".sidenav").sidenav("open"):$(".sidenav").sidenav("close")}),$(".sidenav").sidenav({onOpenStart:function(){isOpen=!0,$header.addClass("open-drawer"),$menu.addClass("is-active"),$slideMenu.addClass("menu-open")},onCloseEnd:function(){isOpen=!1,$header.removeClass("open-drawer"),$menu.removeClass("is-active"),$slideMenu.removeClass("menu-open")}})}),$(function(){$("#lang_menu li a").click(function(){var e=window.location.toString(),n=window.location.pathname.split("/"),t=n[n.length-2],a=n[n.length-1],o=$(this).data("lang");window.location=e.replace(t+"/"+a,o+"/"+a)}),$("#lang_select").on("change",function(){var e=$(this).val(),n=window.location.toString(),t=window.location.pathname.split("/"),a=t[t.length-2],o=t[t.length-1];return e&&(window.location=n.replace(a+"/"+o,e+"/"+o)),!1})});var mq={smUp:"screen and (min-wdth: 600px)",mdUp:"screen and (min-width: 960px)",lgUp:"screen and (min-width: 1280px)",xlUp:"screen and (min-width: 1920px)",xsDown:"screen and (max-width: 599px)",smDown:"screen and (max-width: 959px)",mdDown:"screen and (max-width: 1279px)",lgDown:"screen and (max-width: 1919px)"};function mqAddClass(e){$(e).each(function(){var e=$(this).data("class");$(this).addClass(e)})}function mqRemoveClass(e){$(e).each(function(){var e=$(this).data("class");$(this).removeClass(e)})}var handler_smUp={match:function(){mqAddClass(".mq-sm-up")},unmatch:function(){mqRemoveClass(".mq-sm-up")}},handler_mdUp={match:function(){mqAddClass(".mq-md-up")},unmatch:function(){mqRemoveClass(".mq-md-up")}},handler_lgUp={match:function(){mqAddClass(".mq-lg-up")},unmatch:function(){mqRemoveClass(".mq-lg-up")}},handler_xlUp={match:function(){mqAddClass(".mq-xl-up")},unmatch:function(){mqRemoveClass(".mq-xl-up")}},handler_xsDown={match:function(){mqAddClass(".mq-xs-down")},unmatch:function(){mqRemoveClass(".mq-xs-down")}},handler_smDown={match:function(){mqAddClass(".mq-sm-down")},unmatch:function(){mqRemoveClass(".mq-sm-down")}},handler_mdDown={match:function(){mqAddClass(".mq-md-down")},unmatch:function(){mqRemoveClass(".mq-md-down")}},handler_lgDown={match:function(){mqAddClass(".mq-lg-down")},unmatch:function(){mqRemoveClass(".mq-lg-down")}};enquire.register(mq.smUp,handler_smUp).register(mq.mdUp,handler_mdUp).register(mq.lgUp,handler_lgUp).register(mq.xlUp,handler_xlUp).register(mq.xsDown,handler_xsDown).register(mq.smDown,handler_smDown).register(mq.mdDown,handler_mdDown).register(mq.lgDown,handler_lgDown),$(function(){$("#news_carousel").slick({dots:!0,infinite:!0,speed:500,slidesToShow:2,arrows:!1,autoplay:!0,autoplaySpeed:5e3,slidesToScroll:1,responsive:[{breakpoint:700,settings:{slidesToShow:1,slidesToScroll:1}}]})}),$(function(){var n=$("#testimonial_carousel");n.slick({dots:!1,infinite:!0,speed:1000,autoplay:!0,autoplaySpeed:3e3,slidesToShow:1,fade:!0,arrows:!1,pauseOnHover:!1}),$("#logo_nav a").click(function(){var e=$(this).data("index");n.slick("slickGoTo",e)}),n.on("afterChange",function(e,n,t){var a=t+1;$("#logo_nav a").removeClass("active").addClass("inactive"),$("#logo_nav > .figure-btn:nth-child("+a+") a").addClass("active").removeClass("inactive")})});var tag=document.createElement("script");tag.src="https://www.youtube.com/iframe_api";var firstScriptTag=document.getElementsByTagName("script")[0],player;function onYouTubeIframeAPIReady(){player=new YT.Player("video_iframe",{height:"360",width:"640",videoId:"yFdMwUSYjBY",playerVars:{autoplay:0},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange}});player2=new YT.Player("video_iframe2",{height:"360",width:"640",videoId:"4M3tEabb1SI",playerVars:{autoplay:0},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange}});player3=new YT.Player("video_iframe3",{height:"360",width:"640",videoId:"mI4dS2Fhkbs",playerVars:{autoplay:0},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange}});player4=new YT.Player("video_iframe4",{height:"360",width:"640",videoId:"dh_Y8q7Slt0",playerVars:{autoplay:0},events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange}});}function onPlayerReady(e){}firstScriptTag.parentNode.insertBefore(tag,firstScriptTag);var done=!1;function onPlayerStateChange(e){e.data!=YT.PlayerState.PLAYING||done||(setTimeout(stopVideo,6e3),done=!0)}function playVideo(){player.playVideo()}function stopVideo(){player.stopVideo()}$(function(){$(".modal").modal({onOpenEnd:function(){playVideo()},onCloseEnd:function(){stopVideo()}}),$(".modal .modal-close").click(function(){stopVideo()})});var $header=$("#header"),$pageNav=$("#page_nav"),sticky=0;function fixedNav(){window.pageYOffset>sticky?$header.addClass("fixed"):$header.removeClass("fixed")}function fixedFabNav(){500<window.pageYOffset?$pageNav.addClass("show"):$pageNav.removeClass("show")}0<$("#header").length&&(sticky=header.offsetTop+100),window.onscroll=function(){fixedNav(),fixedFabNav()},$(document).ready(function(){$("#preloader").delay(300).fadeOut("fast"),$(".transition-page").addClass("page-fadeUp-transition-enter").delay(1e3).queue(function(){$(this).removeClass("page-fadeUp-transition-enter").addClass("page-fadeUp-transition-enter-active").dequeue().delay(500).queue(function(){$(this).removeClass("page-fadeUp-transition-enter-active").addClass("page-fadeUp-transition-exit").dequeue()})}),$(".scrollnav").navScroll({scrollSpy:!0,activeParent:!0,activeClassName:"current"}),(new WOW).init(),$("#feature_parallax").enllax(),$("#testimonials_parallax").enllax(),$(".collapsible").collapsible(),$(".select").formSelect(),$(".tooltipped").tooltip(),$("#pricing .tabs").tabs({swipeable:!0});$.validate({form:"#contact_form",onSuccess:function(e){return M.toast({html:'<span>Message Sent</span><button onclick="M.Toast.dismissAll()" class="btn-icon waves-effect toast-action"><i class="material-icons">close</i></button>'}),!1}}),$.validate({form:"#login_form"}),$.validate({form:"#register_form",modules:"security"})});