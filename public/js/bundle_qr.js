...
createQr =function(amount,description,canvasId) {
  const qrRawData = {
    qrType: 'DYNAMIC', // STATIC
    bin: '970416',
    receiverNumber: '393982668',
  ...
  qr.toCanvas(canvas, qrString, function (error) {
...
},{"./libs/CRCCalculator":5,"./libs/qrBuilder":6,"./libs/qrStringGenerator":7,"qrcode":49}],5:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":2,"crc":20}],6:[function(require,module,exports){
const QR_TYPE = {
  STATIC: '11',
  DYNAMIC: '12'
};
...
},{"../cjs/crc1":33}],9:[function(require,module,exports){
const results = require('../cjs/crc16').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc16":34}],10:[function(require,module,exports){
const results = require('../cjs/crc16ccitt').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc16ccitt":35}],11:[function(require,module,exports){
const results = require('../cjs/crc16kermit').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc16kermit":36}],12:[function(require,module,exports){
const results = require('../cjs/crc16modbus').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc16modbus":37}],13:[function(require,module,exports){
const results = require('../cjs/crc16xmodem').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc16xmodem":38}],14:[function(require,module,exports){
const results = require('../cjs/crc24').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc24":39}],15:[function(require,module,exports){
const results = require('../cjs/crc32').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc32":40}],16:[function(require,module,exports){
const results = require('../cjs/crc32mpeg2').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc32mpeg2":41}],17:[function(require,module,exports){
const results = require('../cjs/crc8').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc8":42}],18:[function(require,module,exports){
const results = require('../cjs/crc81wire').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crc81wire":43}],19:[function(require,module,exports){
const results = require('../cjs/crcjam').default;
module.exports = results;
module.exports.default = results;

},{"../cjs/crcjam":44}],20:[function(require,module,exports){
module.exports = {
  crc1: require('./crc1'),
  crc8: require('./crc8'),
...
},{"./crc1":8,"./crc16":9,"./crc16ccitt":10,"./crc16kermit":11,"./crc16modbus":12,"./crc16xmodem":13,"./crc24":14,"./crc32":15,"./crc32mpeg2":16,"./crc8":17,"./crc81wire":18,"./crcjam":19}],21:[function(require,module,exports){
"use strict";
...
},{"./calculators/crc1.js":21,"./define_crc.js":46}],34:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc16.js":22,"./define_crc.js":46}],35:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc16ccitt.js":23,"./define_crc.js":46}],36:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc16kermit.js":24,"./define_crc.js":46}],37:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc16modbus.js":25,"./define_crc.js":46}],38:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc16xmodem.js":26,"./define_crc.js":46}],39:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc24.js":27,"./define_crc.js":46}],40:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc32.js":28,"./define_crc.js":46}],41:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc32mpeg2.js":29,"./define_crc.js":46}],42:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc8.js":30,"./define_crc.js":46}],43:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crc81wire.js":31,"./define_crc.js":46}],44:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./calculators/crcjam.js":32,"./define_crc.js":46}],45:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./create_buffer.js":45}],47:[function(require,module,exports){
'use strict';
...
},{"./can-promise":50,"./core/qrcode":66,"./renderer/canvas":73,"./renderer/svg-tag.js":74}],50:[function(require,module,exports){
...
},{"./mode":63}],53:[function(require,module,exports){
function BitBuffer () {
  this.buffer = []
  this.length = 0
}
...
},{"./mode":63,"encode-utf8":48}],56:[function(require,module,exports){
...
},{"./error-correction-level":57}],57:[function(require,module,exports){
exports.L = { bit: 1 }
exports.M = { bit: 0 }
exports.Q = { bit: 3 }
exports.H = { bit: 2 }
...
},{"./mode":63,"./utils":70}],62:[function(require,module,exports){
/**
...
},{"./regex":68,"./version-check":71}],64:[function(require,module,exports){
const Mode = require('./mode')
...
},{"./mode":63}],65:[function(require,module,exports){
...
},{"./galois-field":60}],66:[function(require,module,exports){
const Utils = require('./utils')
const ECLevel = require('./error-correction-level')
...
},{"./alignment-pattern":51,"./bit-buffer":53,"./bit-matrix":54,"./error-correction-code":56,"./error-correction-level":57,"./finder-pattern":58,"./format-info":59,"./mask-pattern":62,"./mode":63,"./reed-solomon-encoder":67,"./segments":69,"./utils":70,"./version":72}],67:[function(require,module,exports){
...
},{"./polynomial":65}],68:[function(require,module,exports){
const numeric = '[0-9]+'
...
},{"./alphanumeric-data":52,"./byte-data":55,"./kanji-data":61,"./mode":63,"./numeric-data":64,"./regex":68,"./utils":70,"dijkstrajs":47}],70:[function(require,module,exports){
let toSJISFunction
...
},{"./error-correction-code":56,"./error-correction-level":57,"./mode":63,"./utils":70,"./version-check":71}],73:[function(require,module,exports){
const Utils = require('./utils')
